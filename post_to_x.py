...
def generate_shitpost():
    ...
    prompt = (
        ...
        f"Make it related to the analysed trends, insightful, savage and  humorous. Your response should be just the post, nothing else (under 200 characters, no self-deprecating humor, emojis allowed)."
    )
