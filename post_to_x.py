...
def generate_shitpost():
    ...
    prompt = f""" write a banger tweet about AI, tech or physics. 
    absolute necessity: funny and short. tweet sized.
    optional: insightful and/or digestible for non tech people
